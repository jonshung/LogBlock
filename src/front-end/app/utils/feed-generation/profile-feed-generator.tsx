...
export const profileFeedGenerate = async ( excluding: number[], lim: number ) => {
    ...
    let data: PostData[] = [];
    try {
        let resp = await fetchAuthorized(`${process.env.BACKEND_HOSTNAME_SERVER}:${process.env.BACKEND_PORT_SERVER}/posts/by/${currentUser.userID}/limit`, 
