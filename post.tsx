...
import { PostData, Media, Tag, Comment, } from '@/app/interfaces/common-interfaces';
...
const Post: React.FC<PostProps> = ({ post, addComment, deletePost, onSave }) => {
    ...
    const handleAddComment = () => {
        if (newComment.trim()) {
            const newCommentData: Comment = {
                ...
                authorName: 'Current User', // Mock user name
                authorAvatar: 'https://via.placeholder.com/50', // Mock user avatar
            };
